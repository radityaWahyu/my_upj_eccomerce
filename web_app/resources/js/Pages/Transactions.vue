...
<template>
    ...
    <div class="lg:container p-4 min-h-[600px]">
        <div class="lg:w-3/4 mx-auto space-y-4">
            ...
            <div class="space-y-4" v-if="transactions.data.length > 0">
                <!-- <div>
            ...
            <div v-if="transactions.data.length === 0" class="w-full">
                <img
                    :src="EmptyCart"
                    alt="empty_cart"
                ...
                <p class="text-center text-muted-foreground">
                    Silahkan membuat transaksi pemesanan terlebih dahulu dengan
                    memilih produk yang tersedia dan mengirim pesanan.
                </p>
            </div>
            <div v-if="transactions === null" class="w-full">
                ...
                <h2
                    class="scroll-m-20 border-b pb-2 text-xl font-semibold tracking-tight transition-colors text-center"
                >
                    Anda harus LogIn terlebih dahulu agar dapat melihat daftar
                    transaksi anda.
                </h2>
                <p class="text-center text-muted-foreground">
