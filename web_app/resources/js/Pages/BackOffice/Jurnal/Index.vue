...
const columns: ColumnDef<TJurnal>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) =>
      h("div", { class: "font-semibold text-muted-foreground" }, row.original.shop),
  },
  {
    ...
    cell: ({ row }) =>
      h(
        "div",
        { class: "font-semibold text-muted-foreground" },
        row.original.transaction_id !== null ? row.original.transaction_id : "-"
      ),
  },
  {
    accessorKey: "income",
  ...
  },
  {
    ...
    cell: ({ row }) => h("div", { class: "text-right" }, row.original.transaction_date),
  },
  {
    id: "actions",
    enableHiding: false,
...
<template>
  ...
  <div class="space-y-2 mx-auto w-full">
    ...
    <div class="w-full space-y-4">
      ...
      >
        <div>
          <h5 class="text-muted-foreground text-xs font-medium">Total Pemasukan</h5>
          <h4 class="scroll-m-20 text-xl font-semibold tracking-tight text-primary">
            {{ Rupiah(total_income) }}
          </h4>
        </div>
        <div>
          <h5 class="text-muted-foreground text-xs font-medium">Total Pengeluaran</h5>
          <h4 class="scroll-m-20 text-xl font-semibold tracking-tight text-red-500">
            {{ Rupiah(total_expense) }}
          </h4>
        </div>
        <div>
          <h5 class="text-muted-foreground text-xs font-medium">Saldo</h5>
      ...
      <div class="flex items-center py-1 justify-between w-full">
        ...
        <div class="flex items-center gap-3">
          ...
          <Button variant="default" @click="getJurnal"> Tampilkan </Button>
        </div>
      </div>
      <DataTable
        ref="jurnalsTable"
        ...
        <template #empty>
          ...
          >
            ...
            <p class="text-left">
              ...
              Tidak terdapat transaksi jurnal pada mulai dari transaksi pemasukan dan
