    ...
    <div class="block w-1/2 mx-auto space-y-2">
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex gap-2">
                    ...
                    <Button
                        ...
                        :disabled="productForm.processing"
                    >
                        <span v-if="productForm.processing"
                            >Menyimpan data...</span
                        >
        ...
        <Alert class="bg-secondary shadow-inner shadow-gray-100 max-w-2xl">
            <AlertDescription class="text-xs">
                Silahkan anda mengisi data produk atau jasa yang akan disediakan
                dalam siste MY UPJ.
            </AlertDescription>
        </Alert>
                ...
                <FormItem>
                    ...
                    <FormControl>
                        ...
                        <Alert class="bg-yellow-100" v-else>
                            ...
                            <AlertDescription>
                                Data Kategori tidak ditemukan dalam sistem,
                                silahkan ditambahkan terlebih dahulu
                            </AlertDescription>
                        </Alert>
                    </FormControl>
