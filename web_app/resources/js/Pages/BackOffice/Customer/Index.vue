...
import CustomerNameBox from "@/Components/backoffice/customer/CustomerNameBox.vue";
import CustomerButton from "@/Components/backoffice/customer/CustomerButton.vue";
...
const columns: ColumnDef<TCustomer>[] = [
    {
        ...
        cell: ({ row }) => h(CustomerNameBox, { customer: row.original }),
    },
    {
        accessorKey: "phone",
        header: ({ column }) => {
    ...
    },
    {
        ...
        cell: ({ row }) =>
            h(CustomerVerifiedBox, { verified: row.original.verified }),
    },
    {
        accessorKey: "enabled",
        header: ({ column }) => {
        ...
        cell: ({ row }) =>
            h(CustomerEnabledBox, { enabled: row.original.enabled }),
    },
    {
        id: "actions",
        enableHiding: false,
        ...
        <div class="space-y-2">
            ...
            <Alert class="bg-secondary shadow-inner shadow-gray-100 max-w-2xl">
                <AlertDescription class="text-xs">
                    Halaman untuk memanajemen Pelanggan yang telah mendaftar
                    pada sistem ini.
                </AlertDescription>
            </Alert>
        </div>
