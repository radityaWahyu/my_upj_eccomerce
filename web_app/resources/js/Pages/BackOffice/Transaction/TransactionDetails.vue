  ...
  <div class="py-8 space-y-10 container bg-white">
    <div class="space-x-2">
      <Button variant="outline" size="icon" as-child>
        <Link :href="route('backoffice.transaction.index', 'dibayar')" replace>
    ...
    <div class="flex items-center justify-between pb-10">
      <div class="divide-y divide-gray-300">
        <div class="text-3xl font-semibold text-tomato">APLIKASI MY UPJ</div>
        <div class="text-gray-500 font-medium text-sm">SMKN 1 PURWOSARI KAB PASURUAN</div>
      </div>
    ...
    <div class="grid grid-cols-2">
      ...
      <div>
        ...
        <div class="grid grid-cols-[30%_70%] items-center">
          ...
          <p class="font-medium capitalize">: {{ transaction.customer_name }}</p>
        </div>
        <div class="grid grid-cols-[30%_70%] items-center">
          <p class="text-sm">Tanggal Pemesanan</p>
      ...
      <table class="w-full text-gray-500 dark:text-gray-400">
        <thead class="text-xs text-gray-900 uppercase bg-gray-50">
          <tr class="border-y-2 border-gray-500">
            <th scope="col" class="px-6 py-3 text-left">Nama Item</th>
        ...
        <tbody>
          ...
          <tr class="bg-white border-b">
            <td
              colspan="3"
              class="px-6 py-4 text-sm font-semibold text-right text-gray-800"
            >
              Total Bayar
            </td>
            <td colspan="3" class="px-6 py-4 font-medium text-right text-gray-800">
          ...
          <tr class="bg-white border-b">
            ...
            <td colspan="3" class="px-6 py-4 font-semibold text-right text-tomato">
