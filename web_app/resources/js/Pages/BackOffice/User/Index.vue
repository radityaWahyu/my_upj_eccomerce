    ...
    cell: ({ row }) => {
      ...
      return h(
        ...
        h(ButtonAction, {
          ...
          onUpdated: (id: string) => router.get(route("backoffice.user.edit", id)),
        })
      );
    },
  },
  ...
  <div class="space-y-2 mx-auto w-full">
    <div class="space-y-2">
      ...
      <Alert class="bg-secondary shadow-inner shadow-gray-100 max-w-2xl">
        <AlertDescription class="text-xs">
          Halaman untuk memanajemen User yang terdapat pada setiap Unit Layanan di SMKN 1
          Purwosari. Untuk menambah data baru silahkan mengklik tombol
    ...
    <div class="w-full">
      <div class="flex items-center justify-between py-4">
        <Input placeholder="Cari user..." v-model="search" class="w-1/2 bg-white" />
