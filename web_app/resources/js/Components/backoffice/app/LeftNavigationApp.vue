...
<template>
  <div class="flex-1 overflow-y-auto scrollbar pb-2" id="backoffice-left-navigation">
    <nav class="grid items-start px-2 text-sm font-medium lg:px-4 gap-4">
      ...
      <div class="space-y-1">
        ...
        <link-navigation
          ...
          :is-active="$page.url.startsWith('backoffice/unit_layanan', 1)"
          v-if="userProfile.admin.level === 'administrator'"
        >
          <Store class="h-4 w-4" />
          Unit Pelayanan
      ...
      <div class="space-y-1">
        ...
        <link-navigation
          ...
          :is-active="$page.url.startsWith('backoffice/transaksi/selesai', 1)"
        >
      ...
      <div class="space-y-1">
        ...
        <link-navigation
          ...
          :is-active="$page.url.startsWith('backoffice/jurnal/all', 1)"
        >
        ...
        <link-navigation
          ...
          :is-active="$page.url.startsWith('backoffice/jurnal/unit', 1)"
          v-if="userProfile.admin.level === 'administrator'"
        >
          <Banknote class="h-4 w-4" />
          Keuangan Per Unit
      ...
      <div class="space-y-1" v-if="userProfile.admin.level === 'administrator'">
