...
import { Images, PenLine, Trash } from "lucide-vue-next";
...
<template>
    <div class="space-x-2 w-15">
        <Button
            ...
            variant="secondary"
            size="icon"
            @click="router.get(route('backoffice.product.images', id))"
        >
            <Images class="w-4 h-4 text-blue-600" />
        </Button>
        <Button
            type="button"
            variant="secondary"
