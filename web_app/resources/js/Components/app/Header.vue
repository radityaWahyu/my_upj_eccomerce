...
<template>
  <div class="min-w-max bg-nasplesyellow lg:sticky lg:z-20 lg:top-0">
    <div class="sm:container px-2 h-[55px] flex items-center justify-between">
      <div id="logo" class="flex items-center gap-1">
        ...
        <div>
          <h4 class="font-semibold text-xl text-tomato line">MYUPJ</h4>
      ...
      <div class="w-[calc(100vw/3.2)] lg:block hidden">
        <div class="relative w-full items-center mx-auto">
          ...
          <span class="absolute start-0 inset-y-0 flex items-center justify-center px-2">
            <MagnifyingGlassIcon class="size-6 text-muted-foreground text-tomato" />
          </span>
        </div>
      </div>
      <div class="flex items-center lg:divide-x-2 lg:divide-yellow-600">
        <div class="lg:block hidden px-2" id="desktop-navigation">
          <ul class="inline-flex text-sm font-medium gap-1">
            <li>
              <TopLink :to="route('frontend.index')" :active="$page.component === 'Home'">
                Beranda
              </TopLink>
            </li>
            <li>
              <TopLink
                ...
                :active="
                  $page.url.startsWith('products', 1) || $page.url.startsWith('search', 1)
                "
              >
                Produk & Jasa
              </TopLink>
            ...
            <li>
              <TopLink
                ...
                :active="$page.url.startsWith('unit-layanan', 1)"
              >
                Unit Layanan
              </TopLink>
            </li>
        ...
        <div class="flex items-center gap-3 px-2">
          ...
          >
            <div class="w-full divide-y divide-gray-200" v-if="customerProfile === null">
              <div class="p-2">
                <Link
            ...
            <div class="w-full divide-y divide-gray-200" v-else>
              <div class="p-3">
                <strong class="block p-1 text-xs font-medium uppercase text-gray-400">
                  Profil Saya
                </strong>
