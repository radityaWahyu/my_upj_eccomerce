...
<template>
  <div class="rounded-sm border border-gray-200 bg-white p-3 shadow-sm">
    <div class="grid grid-cols-[40%_20%_15%_20%_5%] items-center gap-1 px-1">
      <div class="flex items-center gap-2">
        ...
        >
          {{ cart.name }}
          <span class="ml-2 text-xs text-blue-500" v-if="productCartForm.processing">
            updating...
          </span>
      ...
      <div class="text-sm font-medium text-gray-900 text-left">
        <p class="text-xs text-muted-foreground font-medium">Harga Satuan</p>
        {{ Rupiah(cart.price) }}
      </div>
