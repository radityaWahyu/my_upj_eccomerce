...
const cancelTransaction = () => {
    router.put(route('frontend.transaction.cancel', props.transaction.id), {}, {
...
<template>
  <div class="rounded-lg border border-gray-200 bg-white p-3 shadow-sm" v-if="loading">
    <div class="space-y-1">
  ...
  <div class="rounded-lg border border-gray-200 bg-white p-3 shadow-sm" v-else>
    <div class="space-y-1">
    ...
    'bg-green-300 text-green-600': transaction.status === 'pesan'
      ...
      <div class="grid grid-cols-[60%_40%] items-center">
        <div>
          <p class="text-xs font-semibold">Unit layanan {{ transaction.shop }}</p>
        ...
        <div class="divide-x divide-gray-200 w-full flex items-center">
          <div class="grow py-3 px-4 text-center">
            ...
            <h3 class="text-lg font-semibold">{{ transaction.product_count }} Item</h3>
          </div>
          <div class="grow py-3 px-4 text-center">
      ...
      <div class="w-full flex items-center justify-end gap-2 py-2">
        <Link
