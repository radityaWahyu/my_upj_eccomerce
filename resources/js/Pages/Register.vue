...
<template>
    ...
    <div class="relative lg:bg-nasplesyellow/10 h-full lg:flex lg:items-start">
        <Transition>
            <div
        ...
        <div
            class="lg:w-2/5 bg-gray-50 h-full lg:h-full flex flex-col justify-center gap-4 lg:shadow-inner shadow-gray-200"
        >
            <Link
                :href="route('frontend.index')"
            ...
            <div class="px-4">
                <div class="px-4 mt-2">
                    ...
                    >
                        ...
                        Silahkan mengisi data sesuai dengan pertanyaan yang ada
                        di form pendaftaraan dengan benar karena sistem akan
                        meminta verifikasi pendaftar.
                    </div>
                    <div>
                        <form
                            @submit="onSubmit"
                        ...
                        >
                            ...
                            <div class="divide-y divide-gray-300 space-y-2">
                                <div>
                                    <button
                                        type="submit"
                                        @click="onSubmit"
