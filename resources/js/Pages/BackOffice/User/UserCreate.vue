    ...
    <div class="block w-1/2 mx-auto space-y-2">
        ...
        >
            ...
            <AlertDescription class="text-xs">
                Data Pegawai masih kosong silahkan mengisi data Pegawai terlebih
                dahulu.
            </AlertDescription>
        </Alert>
        <Alert
            class="bg-secondary shadow-inner shadow-gray-100 max-w-2xl"
            v-else
        >
            <AlertDescription class="text-xs">
